...
int main(int argc, char *argv[]){
  crack("$6$AS$Y7qqbFIz2gpNYNY/pYCFcQ5DIklCANUMqNQARPmectRRK/tW3PjWawxw44WizIB8xhAWIJfp5zaKA5.c0z3VD/");		//Copy and Paste your ecrypted password here using EncryptShA512 program
